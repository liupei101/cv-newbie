"""
This is an implementation of AlexNet by Alex Krizhevsky at all.
...
class AlexNet(object):
    ...
    def create(self):
        ...
        # pool5 = [n, 6, 6, 256]
        # height_output = (height - filter_height) / stride_y + 1
...
""" 
def conv(x, filter_height, filter_width, num_filters, stride_y, stride_x, \
    ...
    with tf.variable_scope(name) as scope:
        ...
        # In the cases of multiple groups, split inputs & weights and
            ...
            conv = tf.concat(axis=3, value=output_groups)
